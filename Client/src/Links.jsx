...
import symbol4 from './assets/ig-instagram-icon.svg'
import symbol5 from './assets/wa-whatsapp-icon.svg'
function Links (){
    const list=[
        ...
        {id: 4,title: 'instagram',symbol: symbol4,link: 'https://www.instagram.com/surath_83'},
        {id: 5,title: 'whatsapp',symbol: symbol5,link: ''}
    ];
    return(
